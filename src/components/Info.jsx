...
const Info = ({animeInfo}) => {
    return (
        <Fragment>
            ...
            <h2 className="text-white font-bold text-3xl">{animeInfo.title}</h2>
            ...
            <div className="flex mt-5">
                ...
                <div className="flex">
                    <p className="text-white font-bold my-auto mr-2">Demographics:</p>
            ...
            <div className="flex mt-10">
                {
                    animeInfo.airing 
                    ? 
                    <div className="mr-3 bg-gradient-to-r from-green-500 to-green-600 rounded-md py-2 px-6 text-center">
                        <p className="text-white font-medium"><i className="fas fa-tv mr-2"></i>{animeInfo.status}</p>
                    </div>
                    : 
                    <div className="mr-3 bg-gradient-to-r from-red-500 to-red-600 rounded-md py-2 px-6 text-center">
                        <p className="text-white font-medium"><i className="fas fa-tv mr-2"></i>{animeInfo.status}</p>
                    </div>
                }
